...
namespace InvestigationCaseManagement.Data.Migrations
{
    ...
    [Migration("20250227004257_AddNotificacion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestigationCaseManagement.Data.Archivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestigationCaseManagement.Data.Auditoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DatosEntidad")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InvestigationCaseManagement.Data.Caso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Actuaciones")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AreaApoyo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("MontoExpuesto")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("MovilAfectado")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ObjetivoAgraviado")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PersonasInvolucradas")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InvestigationCaseManagement.Data.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestigationCaseManagement.Data.Archivo", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Investigador")
                        .WithMany()
